...
if (result && result.node) {
  if (parseInt(result.node) >= expectedVersion) {
    console.log(
    ...
    console.log(
      ...
      '-------******* Package installation(npm install) or Project startup command(npm start) failed due to Node Version, Please install and use Node Version >=' +
        expectedVersion +
        '*******-------'
    );
    console.log(
